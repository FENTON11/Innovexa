...
function Hero() {
  ...
  return (
    <section className="bg-background text-text h-screen flex flex-col justify-center items-center px-6">
      <div className="max-w-6xl w-full flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          ...
          <p className="mt-4 text-secondary text-lg">
            We help businesses and startups create outstanding digital solutions.
          </p>
          <button 
