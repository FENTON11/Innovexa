  ...
  return (
    ...
    >
      <div className='max-w-7xl mx-auto'>
        ...
        >
          At vexacode, we blend innovation, expertise, and technology to deliver
          powerful web, mobile, and TV app solutions that help your business
          grow.
        </motion.p>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          ...
          >
            ...
            <p className='text-white'>
              ...
              engineers who are passionate about building exceptional digital
              products.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className='text-white'>
              We listen to your goals and tailor each solution to match your
          ...
          >
            ...
            <p className='text-white'>
              From idea to deployment and beyond, we offer complete development
              services — including UI/UX, frontend, backend, and support.
            </p>
          </motion.div>
        </div>
